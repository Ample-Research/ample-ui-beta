...
export const sendData = async (file, data, userId) => {
    const url = "https://ample-files-to-qa.azurewebsites.net/api/INITIATE_FILE_PROCESSING?code=DLUzPrto_lHUGoD3LJgYYL6eEgY6GQVdUUn_4ODH4rvqAzFuE9WmEg==";
  ...
  export const checkStatus = async (id) => {
    ...
    const url = "https://ample-files-to-qa.azurewebsites.net/api/CHECK_TASK_STATUS?code=DLUzPrto_lHUGoD3LJgYYL6eEgY6GQVdUUn_4ODH4rvqAzFuE9WmEg==&task_id=";
